...
We use the Collimated Beam Projector (CBP) -- a 30\,cm Schmidt telescope refitted with a laser -- to produce ghosts on the focal plane.
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/lsstcam_focal_plane_mosaic_2025-11-05_000406.jpg}
    \caption{Post-ISR image of the LSSTCam focal plane (visit 2025110500406; {\it i} band) with optical ghosts created by a bright star (CD-62 181) in the top right corner. } 
